...
<!DOCTYPE html>
<html><head><title> modify_01_Form </title></head>
<body onload="passwdFocus()" >
	
	<h2><center> 수정 페이지 : 비번 입력 </center></h2>
	<% System.out.println( "\n수정페이지 (비번 입력) : modify_01_Form.jsp : 뷰 " );  %>
	
	<form action="modifyfrom.do" method="post" name="passwdform" onsubmit="return passwdCheck()">
