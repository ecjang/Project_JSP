...
<body onload="b_modifyFocus()" >
	...
	<% System.out.println("  -> 06_Book_Modify_Form"); %>
	<h3> <center> 도서정보 수정양식 페이지 </center> </h3>
	
	<form action="book_modifypro " method="post" name="b_modifyform" 
		...
		<table align="center" style="width:50%" >
			...
			<tr>
				<th> 제목 : </th>
				<td> <input value="수정한 ${dto.title} " type="text" name="b_title" 
			...
			<tr>
				...
				<textarea name="b_subtitle" class="input" cols="40" 
					rows="10"> 수정한 ${dto.subtitle} </textarea>
				</td>
			</tr>
			
			<tr>
				<th> 저자 : </th>
				<td> <input value="다른 ${dto.author}" type="text" name="b_author" 
					class="input" maxlength="30">
				</td>
			</tr>
			...
			<tr>
				<th> 종류 : </th>
				<td> <input value="다른 ${dto.kind}" name="b_kind" type="text" 
					class="input" maxlength="30" > </td>
			</tr>
			...
			<tr>
				<th colspan="2">
					...
					<input type="button" value="목록보기" class="inputButton" 
						onclick="window.location='book_list?num=${dto.b_num}&pageNum=${pageNum}'" >
