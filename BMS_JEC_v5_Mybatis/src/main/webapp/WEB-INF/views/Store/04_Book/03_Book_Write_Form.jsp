...
<body onload="book_writeFocus()">
	...
	<% System.out.println("  -> 03_Book_Write_Form "); %>
	<h3> <center> 신간 도서 정보 입력 페이지 </center> </h3>
	
	<form action="book_writepro" method="post" name="book_writeform" 
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" class="inputButton" value="목록"
						onclick="window.location='book_list?b_num=${b_num}&pageNum=${pageNum}'">
				</td>
			</tr>
		</table>
