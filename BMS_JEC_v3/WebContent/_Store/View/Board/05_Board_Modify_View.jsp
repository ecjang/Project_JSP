...
<body onload="board_modifyFocus()" >
	...
	<% System.out.println( "  -> 05_Board_Modify_View " );  %>
	
	<form action="board_modify_pro.do" method="post" name="modifyform" onsubmit="return board_modifyCheck()" >
		...
		<table align="center" style="width:50%" >
			...
			<tr>
				<th> 글내용 : </th>
				<td colspan="3"> <textarea name="content" class="input" cols="50" rows="10"> 수정한 글내용 ${n}</textarea></td>
			</tr>
			...
			<tr>
				<th colspan="4">
					...
					<input type="button" value="목록보기" class="inputButton" 
						onclick="window.location='board_list.do?no=${no}&pageNum=${pageNum}&kind=${dto.KIND}'" >
