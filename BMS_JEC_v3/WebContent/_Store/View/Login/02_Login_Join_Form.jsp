...
<body onload="inputFocus();" >
	...
	<% System.out.println("  -> 회원가입 양식 : 02_Login_Join_Form.jsp "); %>
	<h3> 회원가입 양식 페이지 </h3>
	 ...
	 <form action="inputPro.do" method="post" name="inputform" onsubmit="return inputCheck();" >
	 	...
	 	<table>
	 		...
	 		<tr> <th> * 비밀번호 </th>
	 		<td> <input value="${n}${n}" class="input"  type="password" name="passwd" maxlength="10"> </td></tr>
	 		
	 		<tr> <th> * 비밀번호 확인 </th> 
	 		<td> <input value="${n}${n}" class="input" type="password" name="repasswd" maxlength="10"> </td></tr>
