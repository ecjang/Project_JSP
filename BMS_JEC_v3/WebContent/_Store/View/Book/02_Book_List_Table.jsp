...
<body>
	...
	<% System.out.println("  -> 도서목록 메인  : 01_Book_List.jsp "); %>
		...
		<c:if test="${cnt>0}">
			...
			<tr>
				...
				<td align="left" style="margin-left: 20px;"> 
					...
					<a href="book_content.do?b_num=${d.b_num}&pageNum=${pageNum}&number=${number+1}">
						${d.title}</a>
				</td>	
			...
			<tr>
				...
				<th colspan="8">	<!-- 화살표 및 페이지 번호 -->
					...
					<c:if test="${startPage > pageBlock}">	
						<a href="book_list.do"> [◀◀] </a>	
						<a href="book_list.do?pageNum=${startPage-pageBlock}"> [◀] </a>	
					</c:if>
					...
					<c:if test="${pageCount > endPage}">
						<a href="book_list.do?pageNum=${startPage + pageBlock}"> [▶] </a>	
						<a href="book_list.do?pageNum=${pageCount}"> [▶▶]</a>		
					</c:if>
