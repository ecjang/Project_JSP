...
<body onload="board_modifyFocus()" >
	...
	<form action="12_board_modifypro.do" method="post" name="modifyform" onsubmit="return board_modifyCheck()" >
			...
			<tr>
				<th colspan="4">
					...
					<input type="button" value="목록보기" class="inputButton" 
						onclick="window.location='13_board_list.do?no=${no}&pageNum=${pageNum}&kind=${dto.KIND}'" >
